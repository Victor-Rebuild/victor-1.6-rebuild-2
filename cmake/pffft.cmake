...
if (VICOS)
  set(LIBPFFFT_INCLUDE_PATH "${ANKI_EXTERNAL_DIR}/deps/pffft/vicos/include")
  set(LIBPFFFT_LIB_PATH "${ANKI_EXTERNAL_DIR}/deps/pffft/vicos/lib")
elseif (MACOSX)
  set(LIBPFFFT_INCLUDE_PATH "${ANKI_EXTERNAL_DIR}/deps/pffft/mac/include")
  set(LIBPFFFT_LIB_PATH "${ANKI_EXTERNAL_DIR}/deps/pffft/mac/lib")
endif()
