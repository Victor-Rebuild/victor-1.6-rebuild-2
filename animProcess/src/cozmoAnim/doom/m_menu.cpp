...
menuitem_t MainMenu[]=
{
    {1,"M_NGAME",M_NewGame,sf::Event::Key::N},
    {1,"M_OPTION",M_Options,sf::Event::Key::O},
    {1,"M_LOADG",M_LoadGame,sf::Event::Key::L},
    {1,"M_SAVEG",M_SaveGame,sf::Event::Key::S},
    // Another hickup with Special edition.
    {1,"M_RDTHIS",M_ReadThis,sf::Event::Key::R},
    {1,"M_QUITG",M_QuitDOOM,sf::Event::Key::Q}
};
...
{
    {1,"M_EPI1", M_Episode,sf::Event::Key::K},
    {1,"M_EPI2", M_Episode,sf::Event::Key::T},
    {1,"M_EPI3", M_Episode,sf::Event::Key::I},
    {1,"M_EPI4", M_Episode,sf::Event::Key::T}
};
...
{
    {1,"M_JKILL",	M_ChooseSkill, sf::Event::Key::I},
    {1,"M_ROUGH",	M_ChooseSkill, sf::Event::Key::H},
    {1,"M_HURT",	M_ChooseSkill, sf::Event::Key::H},
    {1,"M_ULTRA",	M_ChooseSkill, sf::Event::Key::U},
    {1,"M_NMARE",	M_ChooseSkill, sf::Event::Key::N}
};
...
{
    {1,"M_ENDGAM",	M_EndGame,sf::Event::Key::E},
    {1,"M_MESSG",	M_ChangeMessages,sf::Event::Key::M},
    {1,"M_DETAIL",	M_ChangeDetail,sf::Event::Key::G},
    {2,"M_SCRNSZ",	M_SizeDisplay,sf::Event::Key::S},
    {-1,"",0},
    {2,"M_MSENS",	M_ChangeSensitivity,sf::Event::Key::M},
    {-1,"",0},
    {1,"M_SVOL",	M_Sound,sf::Event::Key::S}
};
...
{
    {1,"",M_ReadThis2,sf::Event::Key::Unknown}
};
...
{
    {1,"",M_FinishReadThis,sf::Event::Key::Unknown}
};
...
{
    {2,"M_SFXVOL",M_SfxVol,sf::Event::Key::S},
    {-1,"",0},
    {2,"M_MUSVOL",M_MusicVol,sf::Event::Key::M},
    {-1,"",0}
};
...
menuitem_t LoadMenu[]=
{
    {1,"", M_LoadSelect,sf::Event::Key::Num1},
    {1,"", M_LoadSelect,sf::Event::Key::Num2},
    {1,"", M_LoadSelect,sf::Event::Key::Num3},
    {1,"", M_LoadSelect,sf::Event::Key::Num4},
    {1,"", M_LoadSelect,sf::Event::Key::Num5},
    {1,"", M_LoadSelect,sf::Event::Key::Num6}
};
...
menuitem_t SaveMenu[]=
{
    {1,"", M_SaveSelect,sf::Event::Key::Num1},
    {1,"", M_SaveSelect,sf::Event::Key::Num2},
    {1,"", M_SaveSelect,sf::Event::Key::Num3},
    {1,"", M_SaveSelect,sf::Event::Key::Num4},
    {1,"", M_SaveSelect,sf::Event::Key::Num5},
    {1,"", M_SaveSelect,sf::Event::Key::Num6}
};
...
void M_ChangeDetail(int choice)
{
    ...
    printferror( "M_ChangeDetail: low detail mode n.a.\n");
...
//      ch = sf::Event::Key::Return;
//    else if (ev->joystickButton.button == 1) //b
//      ch = sf::Event::Key::BackSpace;
//
//  }
	...
	switch(ev->key.code)
	{
	  ...
	  case sf::Event::Key::Escape:
	    saveStringEnter = 0;
	    savegamestrings[saveSlot] = saveOldString;
	    break;

	  case sf::Event::Key::Return:
	    saveStringEnter = 0;
	...
	if (messageNeedsInput == true &&
	    !(ch == ' ' || ch == 'n' || ch == 'y' || ch == sf::Event::Key::Escape))
	    return false;
	...
	switch(ev->key.code)
	{
	case sf::Event::Key::Dash:         // Screen size down
	...
	case sf::Event::Key::Equal:        // Screen size up
	    if (automapactive || chat_on)
		return false;
	    M_SizeDisplay(1);
        I_Sound::startSound(NULL,sfx_stnmov);
	...
	case sf::Event::Key::F2:            // Save
	    M_StartControlPanel();
        I_Sound::startSound(NULL,sfx_swtchn);
	    M_SaveGame(0);
	    return true;

	case sf::Event::Key::F3:            // Load
	    M_StartControlPanel();
        I_Sound::startSound(NULL,sfx_swtchn);
	    M_LoadGame(0);
	    return true;

	case sf::Event::Key::F4:            // Sound Volume
	    M_StartControlPanel ();
	  ...
	  case sf::Event::Key::F5:            // Detail toggle
	    M_ChangeDetail(0);
        I_Sound::startSound(NULL,sfx_swtchn);
	    return true;

	  case sf::Event::Key::F6:            // Quicksave
          I_Sound::startSound(NULL,sfx_swtchn);
	    M_QuickSave();
	    return true;

	  case sf::Event::Key::F7:            // End game
          I_Sound::startSound(NULL,sfx_swtchn);
	    M_EndGame(0);
	    return true;

	  case sf::Event::Key::F8:            // Toggle messages
	    M_ChangeMessages(0);
        I_Sound::startSound(NULL,sfx_swtchn);
	    return true;

	  case sf::Event::Key::F9:            // Quickload
          I_Sound::startSound(NULL,sfx_swtchn);
	    M_QuickLoad();
	    return true;

	  case sf::Event::Key::F10:           // Quit DOOM
          I_Sound::startSound(NULL,sfx_swtchn);
	    M_QuitDOOM(0);
	    return true;

	  case sf::Event::Key::F11:           // gamma toggle
	    usegamma++;
	    if (usegamma > 4)
		usegamma = 0;
